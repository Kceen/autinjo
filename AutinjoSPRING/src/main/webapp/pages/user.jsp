...
<body>
	...
	<div class="container shadow-lg">
		...
		<div class="row p-3" id="userInfoRow">
			<div class="col-lg-12 text-center">
				<p class="lead" id="infoAboutUser"> Informacije o prodavcu </p>
			</div>
			<div class="col-lg-12 text-center">
				<p class="lead" id="user_name"> ${user.username} </p>
			</div>
			
			<div class="col-lg text-center border-bottom mb-2">
				<p class="lead"> E-mail - <span class="font-weight-bold"> ${user.email} </span> </p>
				<p class="lead"> Lokacija - <span class="font-weight-bold"> ${user.lokacija} </span> </p>
				<p class="lead"> Broj telefona - <span class="font-weight-bold"> ${user.brojTelefona} </span> </p>
			</div>
			<div class="col-lg-12 text-center">
				<p class="lead" id=""> Svi oglasi prodavca </p>
			</div>
		</div>
